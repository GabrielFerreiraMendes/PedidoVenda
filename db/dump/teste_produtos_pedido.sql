...
CREATE TABLE `produtos_pedido` (
  ...
  CONSTRAINT `produtos_pedido_ibfk_1` FOREIGN KEY (`NUMERO_PEDIDO`) REFERENCES `dados_gerais_pedido` (`NUMERO_PEDIDO`),
  CONSTRAINT `produtos_pedido_ibfk_2` FOREIGN KEY (`CODIGO_PRODUTO`) REFERENCES `produto` (`CODIGO`)
...
INSERT INTO `produtos_pedido` VALUES (1,4,23,1,1.25,1.25),(2,5,23,12,1.25,15.00),(3,6,23,12,1.25,15.00),(4,7,23,12,1.25,15.00),(5,8,23,10,1.25,12.50);
...
-- Dump completed on 2024-10-07 23:54:05
